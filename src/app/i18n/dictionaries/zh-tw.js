export default {
  ...
  "projects": {
    ...
    "cgc": {
      ...
      "brand": "Web3 遊戲生態系統",
      "description": "協助合作遊戲廠商建構代幣發射平台與遊戲內道具 NFT 化的遊戲與商城平台 (似 Steam)。提供質押、閃兑、NFT 發售、NFT 鑄造、2 級 NFT 交易平台與盲盒開箱等區塊鏈技術，支援以太坊與 Solana 鏈。建構中心化會員功能，提供用戶區塊鏈錢包設置與個人資料綁定。發售平台生態圈代幣。產品上線首日達百位使用者，並於一週後達千位使用者，前期商品完售率達 90%。<br/><br/>使用 NextJS 搭配 TailwindCSS 搭建的技術框架。開發包含代幣發射平台，ERC20 代幣交易、質押、閃兌及 NFT 商城等區塊鍊交易所功能。設計 H5 動畫及互動效果以達成業內流行的美術風格。<br/><br/>建構代碼架構與制定前端開發規範，安排項目時程與人配置。與 UI 和產品協作制定畫面邏輯與美術風格，協同後端開發中心化會員系統。協助將產品從無到有並協助發行平台生態圈代幣。於產品上線後收集使用者反饋並進行前端效能調校、畫面美術調整、與部分前端代碼重構，針對首頁及部分商城頁面進行加載速度優化。"
    },
    "lotusrmp": {
      "title": "RMS 企業風險管理系統",
      brand: "醫療代理管理平台",
