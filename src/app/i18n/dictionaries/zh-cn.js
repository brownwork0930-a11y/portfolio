export default {
  ...
  "projects": {
    ...
    "cgc": {
      ...
      "brand": "Web3 游戏生态系统",
      "description": "协助合作游戏厂商建构代币发射平台与游戏内道具 NFT 化的游戏与商城平台 (似 Steam)。提供质押、闪兑、NFT 发售、NFT 铸造、2 级 NFT 交易平台与盲盒开箱等区块链技术，支援以太坊与 Solana 链。建构中心化会员功能，提供用户区块链钱包设置与个人资料绑定。发售平台生态圈代币。产品上线首日达百位使用者，并于一週后达千位使用者，前期商品完售率达 90%。<br/><br/>使用 NextJS 搭配 TailwindCSS 搭建的技术框架。开发包含代币发射平台，ERC20 代币交易、质押、闪兑及 NFT 商城等区块鍊交易所功能。设计 H5 动画及互动效果以达成业内流行的美术风格。<br/><br/>建构代码架构与制定前端开发规范，安排项目时程与人配置。与 UI 和产品协作制定画面逻辑与美术风格，协同后端开发中心化会员系统。协助将产品从无到有并协助发行平台生态圈代币。于产品上线后收集使用者反馈并进行前端效能调校、画面美术调整、与部分前端代码重构，针对首页及部分商城页面进行加载速度优化。"
    },
    "lotusrmp": {
      "title": "RMS 企业风险管理系统",
      brand: "医疗代理管理平台",
